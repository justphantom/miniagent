...
- 过程文档归档位置：仓库 git 历史（14 个 WEBUI_*/SSE_* 文档于 2026-08-24 从根目录删除，历史可查）；留存的 `docs/WEBUI_NEXT.md` 已于 2026-08-25 沉淀为 `L2/patterns/webui-next-roadmap.md` 并删除，docs/ 目录不复存在。
